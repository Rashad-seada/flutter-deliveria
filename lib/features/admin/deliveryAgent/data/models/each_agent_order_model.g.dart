...
EachOrderModel _$EachOrderModelFromJson(Map<String, dynamic> json) =>
    EachOrderModel(
      ...
      branch: _eachOrderBranchFromJson(json['branch_id']),
...
EachOrderBranchInfo _$EachOrderBranchInfoFromJson(Map<String, dynamic> json) =>
    EachOrderBranchInfo(
      id: json['_id'] as String?,
...
Map<String, dynamic> _$EachOrderBranchInfoToJson(
        EachOrderBranchInfo instance) =>
    <String, dynamic>{
      '_id': instance.id,
      'name': instance.name,
