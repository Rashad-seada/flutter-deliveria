    ...
    FavResponseData(
      ...
      favourites:
          (json['favourites'] as List<dynamic>?)
              ?.map(
                (e) => FavouriteRestaurant.fromJson(e as Map<String, dynamic>),
              )
              .toList(),
...
FavouriteRestaurant _$FavouriteRestaurantFromJson(Map<String, dynamic> json) =>
    FavouriteRestaurant(
      ...
      superCategory: FavouriteRestaurant._stringOrListToListString(
        json['super_category'],
      ),
      subCategory: FavouriteRestaurant._stringOrListToListString(
        json['sub_category'],
      ),
...
Map<String, dynamic> _$FavouriteRestaurantToJson(
  ...
  'logo': instance.logo,
  'super_category': FavouriteRestaurant._listStringToJson(
    instance.superCategory,
  ),
  'sub_category': FavouriteRestaurant._listStringToJson(instance.subCategory),
  'name': instance.name,
