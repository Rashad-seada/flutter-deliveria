...
mixin _$SignupState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorModel apiErrorModel) fail,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(ApiErrorModel apiErrorModel)? fail,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$FailImpl<T> implements Fail<T> {
  const _$FailImpl(this.apiErrorModel);
  ...
  @override
  String toString() {
    return 'SignupState<$T>.fail(apiErrorModel: $apiErrorModel)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return fail?.call(apiErrorModel);
  }
...
abstract class Fail<T> implements SignupState<T> {
  const factory Fail(final ApiErrorModel apiErrorModel) = _$FailImpl<T>;
