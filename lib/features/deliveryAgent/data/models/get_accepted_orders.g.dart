...
AcceptedOrder _$AcceptedOrderFromJson(Map<String, dynamic> json) =>
    AcceptedOrder(
      ...
      userId:
          AcceptedOrderUser.fromJson(json['user_id'] as Map<String, dynamic>),
      orders: (json['orders'] as List<dynamic>)
          .map((e) =>
              AcceptedOrderRestaurantOrder.fromJson(e as Map<String, dynamic>))
          .toList(),
...
AcceptedOrderRestaurantOrder _$AcceptedOrderRestaurantOrderFromJson(
    ...
    AcceptedOrderRestaurantOrder(
      ...
      branch: _acceptedBranchInfoFromJson(json['branch_id']),
...
AcceptedOrderBranchInfo _$AcceptedOrderBranchInfoFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$AcceptedOrderBranchInfoToJson(
        AcceptedOrderBranchInfo instance) =>
    <String, dynamic>{
      '_id': instance.id,
      'name': instance.name,
...
AcceptedOrderItem _$AcceptedOrderItemFromJson(Map<String, dynamic> json) =>
    AcceptedOrderItem(
      ...
      toppingDetails: (json['topping_details'] as List<dynamic>?)
          ?.map((e) =>
              AcceptedOrderToppingDetails.fromJson(e as Map<String, dynamic>))
          .toList(),
...
Map<String, dynamic> _$AcceptedOrderItemToJson(AcceptedOrderItem instance) =>
    <String, dynamic>{
