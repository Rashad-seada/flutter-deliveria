...
AgentOrder _$AgentOrderFromJson(Map<String, dynamic> json) => AgentOrder(
  address: AgentOrderAddress.fromJson(json['address'] as Map<String, dynamic>),
  ...
  orders:
      (json['orders'] as List<dynamic>)
          ...
          .toList(),
  finalPriceWithoutDeliveryCost: _safeNumFromJson(
    json['final_price_without_delivery_cost'],
  ),
...
Map<String, dynamic> _$AgentOrderToJson(
  AgentOrder instance,
) => <String, dynamic>{
