...
class AppLists {
  ...
  static List<Coupon> coupons = [
    Coupon(
      code: 'SUMMER20',
      expiryDate: DateTime(2024, 7, 3),
      discountPercentage: 20,
      restaurants: ['Quick food', 'Pasta Paradise', 'Sushi Spot'],
      isValid: false,
      status: 'Valid',
    ),
    Coupon(
      ...
      restaurants: ['The Grill House', 'Pasta Paradise', 'Sushi Spot'],
      isValid: true,
      status: 'Valid',
    ),
    Coupon(
      ...
      restaurants: ['The Grill House', 'Pasta Paradise', 'ELDEKKA'],
      isValid: true,
      status: 'Valid coupon',
    ),
  ];
